...
const SpaPackageTable = ({ packages, onDelete }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-100 mt-8">
      <div className="flex justify-between items-center px-6 py-4 bg-gradient-to-r from-blue-500 to-indigo-500">
        <h2 className="text-xl font-semibold text-white">Available Spa Packages</h2>
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-200 text-sm">
          <thead className="bg-gray-50">
            <tr>
              {['Title', 'Services', 'Price', 'Address', 'Actions'].map((heading) => (
                <th
                  key={heading}
                  scope="col"
...
export default SpaPackageTable;
