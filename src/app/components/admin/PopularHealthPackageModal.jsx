...
const PopularHealthPackageModal = ({ isOpen, onClose, onSave, editingPackage }) => {
  ...
  useEffect(() => {
    if (editingPackage) {
      ...
      setTests(editingPackage.tests || "");
      setPrice(editingPackage.price || "");
      setOldPrice(editingPackage.oldPrice || "");
      setDiscount(editingPackage.discount || "");
    } else {
      setTitle("");
      setTests("");
      setPrice("");
  ...
  const handleSave = () => {
    if (!title.trim() || !price.trim()) {
      setError("Package title and price are required!");
      return;
    }

    onSave({ title, tests, price, oldPrice, discount });
    onClose();
  };
...
export default PopularHealthPackageModal;
